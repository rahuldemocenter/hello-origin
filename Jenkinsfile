    ...
    stages {
		...
		//echo "Trying to start Edge Runtime instance....!!"
		   script {
                    ...
                    def response = bat(script: 'curl https://originawsdev1.dev-int-aws-us.webmethods.io/integration/rest/origin/agent/generatecode?name:RAHS_Test_My_ERT&description=  \
